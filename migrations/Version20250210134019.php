 ...
 */
final class Version20250210134019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE engine (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, cylinders INT DEFAULT NULL, bore_xstroke VARCHAR(50) DEFAULT NULL, volumetric_ratio VARCHAR(50) DEFAULT NULL, announced_power VARCHAR(150) DEFAULT NULL, couple_announced VARCHAR(150) DEFAULT NULL, power_supply VARCHAR(100) DEFAULT NULL, starter VARCHAR(100) DEFAULT NULL, consumption VARCHAR(100) DEFAULT NULL, co2_emissions VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
